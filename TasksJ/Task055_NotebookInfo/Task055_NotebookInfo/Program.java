...
public class Program {
        public static void main(String[] args) {
                ...
                // Заполняем список:
                notebooks.add(new Notebook(notebooks.size(), "Apple", "MacBook Pro", "Silver", 13.3, "M2", "SSD", 3.2,
                                32, 1024,
                                "MacOS"));
                notebooks.add(
                                new Notebook(notebooks.size(), "Huawei", "MateBook 14", "Grey", 14.2, "AMD Ryzen",
                                                "SSD", 2.2, 16, 512,
                                                "Windows 10"));
                notebooks.add(
                                new Notebook(notebooks.size(), "Asus", "Vivobook Go 14", "Black", 14, "Intel Pentium",
                                                "SSD", 1.1, 8,
                                                256, "no OS"));
                notebooks.add(
                                new Notebook(notebooks.size(), "Huawei", "MateBook D14", "Silver", 14, "Intel Core",
                                                "SSD", 2.4, 8, 512,
                                                "Windows"));
                ...
                notebooks.add(
                                new Notebook(notebooks.size(), "Huawei", "MateBook D16", "Space grey", 16, "Intel Core",
                                                "SSD", 3.3,
                                                16, 512, "Windows"));
